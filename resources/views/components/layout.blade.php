                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                {{-- :active="" che aema : colon che ae "/"" ne indicate kare ke ae expression che string nathi aetle ae jyare /contact avse tyare j ae page active avse nav ma bg color white thase --}}
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            {{-- @guest blade tell if user not logged in then it shows register and login option other wise not  --}}
                            @guest
                            ...
                            {{-- @auth blade tell if user is logged in thne its show log out option  --}}
                            @auth
